          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-14 ">
            ...
            <div className="w-full md:w-[850px] pr-0 md:pr-7">
              <Link href="/" className="group">
                <h1 className="text-[24px] sm:text-[28px] md:text-[28px] lg:text-5xl hover:underline tracking-tight relative inline-block cursor-pointer font-[outfit]">
              ...
              <p className="mt-6 font-[outfit] text-sm sm:text-base">
              ...
              <div className="max-w-7xl py-12">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                  <div className="flex flex-col gap-2">
                    ...
                    <div>
                      <h1 className="hover:underline text-[20px] font-semibold">
                        {" "}
                        <Link href="/">
                  ...
                  <div className=" flex flex-col gap-2">
                    ...
                    <div>
                      <h3 className="hover:underline text-[20px] font-semibold">
                        <Link href="/">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div>
                      <h4 className="hover:underline text-[20px] font-semibold">
                        <Link href={"/"}>
